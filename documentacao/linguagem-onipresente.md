...
### Partida
Jogo realizado entre dois times dentro de um torneio.

### Rodada
Conjunto de partidas de uma mesma etapa da competição.

### Grupo
Divisão de times na fase de grupos do torneio.

### Classificação
Tabela com a pontuação e posição dos times na competição.
...
### Cartão vermelho
Expulsão recebida por um jogador durante a partida.
